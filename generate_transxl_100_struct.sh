...
CKPT="/screamlab/home/tanch/structure-aware_infilling/trained_model_transxl_single_100_struct/training_loss_3.ckpt"
...
python main.py --generate --cuda \
    ...
    --ckpt-path $CKPT \
    --data-file $DATA_FILE \
    --save-path "/screamlab/home/tanch/structure-aware_infilling/gen_midi_transxl_single_100_struct"
